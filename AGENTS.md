...
| Manual operativo de la cuenta | [`clients/copywriters/AGENTS.md`](clients/copywriters/AGENTS.md) |
...
**Los conectores MCP no viajan** — cada persona los activa en su cuenta de Codex.ai.
...
2. `clients/<marca>/AGENTS.md` — el manual de esa marca: paleta medida, gramática,
...
| [`docs/HEYGEN-GEMELA-DIGITAL.md`](docs/HEYGEN-GEMELA-DIGITAL.md) | **Clonar a Valeria en HeyGen** — Digital Twin de video con Avatar V (nunca desde foto), qué grabar, texto del consentimiento, conector y pipeline. Skills en `~/.Codex/skills/heygen-skills` |
...
|---|---|---|---|
| **EBEMA / Click** | [`clients/ebema/`](clients/ebema/AGENTS.md) | `src/brand/ebema.ts` | ⭐ **La referencia.** Sistema de producción completo en `clients/ebema/sistema/`. Dos marcas, tres esquemas |
| **Revex** | [`clients/revex/`](clients/revex/AGENTS.md) | `src/brand/revex.ts` | Revestimientos, rojo, compone **centrado y denso** |
| **Casablanca** | [`clients/casablanca/`](clients/casablanca/AGENTS.md) | `src/brand/casablanca.ts` | Pisos premium, gris + serif itálica, **es aire** |
| **Selfie** | [`clients/selfie/`](clients/selfie/AGENTS.md) | `src/brand/selfie.ts` | Belleza, fucsia #FF007C, packshots del e-commerce |
| **Tierra Calma** | [`clients/tierra-calma/`](clients/tierra-calma/AGENTS.md) | `src/brand/tierracalma.ts` | Parcelas. **QA visual frame a frame obligatorio** |
| **Hilton / Between** | [`clients/hilton/`](clients/hilton/AGENTS.md) | `src/brand/hilton-between.ts` | 4 marcas del complejo; Between y Piso 18 tienen sistema propio, DT y QB no |
| **Piso 18** | [`clients/piso18/`](clients/piso18/AGENTS.md) | `src/brand/piso18.ts` | Centro de eventos del complejo Hilton. **Marca independiente**, como QB. IvyPresto + fucsia `#D4145A`, que **nunca decora**. ⛔ «bodas» está prohibido acá y es obligatorio en DT |
| **Abakos** | [`clients/abakos/`](clients/abakos/AGENTS.md) | `src/brand/abakos.ts` | Préstamos online. Gramática **sin medir todavía** |
| **San Esteban** | [`clients/san-esteban/`](clients/san-esteban/AGENTS.md) | — | Colegio de Antofagasta (cuenta REM). Gramática **medida**; falta material e imagen |
| **Rendic / ARC** | [`clients/rendic/`](clients/rendic/AGENTS.md) | — | El colegio hermano. Burdeo, arco y firma manuscrita. Sistema nuevo desde ago-2026 |
| **Más Center** | [`clients/mascenter/`](clients/mascenter/AGENTS.md) | `clients/mascenter/sistema/` + `src/compositions/mascenter/` | Strip centers (Grupo IFB). Paid medido sobre sept 2026: foto con onda, pastilla roja, Localito. Diseñador: Diego Aguilar |
...
se le mandan a Codex**— va en **español de Chile con tuteo (tú / te / tu / ti)**.
