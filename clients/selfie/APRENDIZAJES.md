...
- **Fucsia** `#FF007C` (pleno, el default de promos) · fucsia claro `#FF64AC` · blanco · tinta `#1A1A1A` · estudio oscuro `#2E2A28` · sparkle `#F5C544`.
- **Tres modos:** (1) fucsia comercial — caja blanca radio 40–60, píldoras fucsia claro, asteriscos del logo como patrón, packshots en abanico, legal abajo; (2) editorial oscuro — Selfie Pro, Men's Work y fechas emotivas, caja glass, sparkles dorados; (3) mundos de campaña y de línea de producto.
- **Logo:** wordmark **SELFI3\*** vertical en el borde derecho, del PNG oficial (`1t0njY5bdOApEupxlB40eRM2MG3Qpz1OW`).
- **Tipografía documentada:** Agrandir (Grand Heavy 800 · Wide Black Italic 900 · Narrow 400) + Open Sans 400/600 — ⚠️ **puesta en duda el 23-09**, ver §8.
- **Formatos:** feed 2250×2813 · story 2250×4000 · reel 1080×1920 · banner web 2001×686 (también 300×250 y 1200×…). Hay GIF animados en el repertorio.
...
- ⚠️ **¿Cambió Coni la tipografía?** El 23-09 subió el editable `GRILLA SEPT_S2-S3.ai` con Informe.txt (carpeta `1Jk6qwNnRJS2cTihvcF5lTGwaQXkaI9U4`) que declara **Scotch Display** (7 estilos, Adobe Fonts), **Chapaza Italic** y **Krub** — no Agrandir + Open Sans. Hasta confirmarlo, **no es regla**: corre `/adn selfie` sobre esa carpeta y pregúntale a Coni si es un cambio de sistema o sólo de esa campaña. → Coni.
- ⚠️ Ese mismo editable tiene **mesa de 1080×1350**; el manual dice que se entrega a **2250×2813**. ¿Cambió el tamaño de entrega? → Coni.
