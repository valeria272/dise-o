...
la fuente es `clients/revex/APRENDIZAJES.md` (léelo completo antes de producir; esto es
sólo lo más confirmado). ⛔ Vale sólo para revex: no se traspasa a otra marca.
