...
description: "SANTA-GOTA — cerebro del cliente: 20 reglas firmes, última cosecha 2026-09-25. Generado desde clients/santa-gota/APRENDIZAJES.md; leerlo antes de diseñar para santa-gota"
metadata:
  type: project
---

⚙️ **Nota generada por `scripts/memoria-cliente.py` en cada /cierre. No se edita acá:**
la fuente es `clients/santa-gota/APRENDIZAJES.md` (léelo completo antes de producir; esto es
sólo lo más confirmado). ⛔ Vale sólo para santa-gota: no se traspasa a otra marca.
