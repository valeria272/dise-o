...
la fuente es `clients/traverso/APRENDIZAJES.md` (léelo completo antes de producir; esto es
sólo lo más confirmado). ⛔ Vale sólo para traverso: no se traspasa a otra marca.
