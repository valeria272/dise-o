"""Casablanca C1 — bodegones cenitales de tablas (sistema gráfico de agosto).
...
BASE_PROMPT = (
    "Overhead flat lay, camera pointing straight down, of about twelve long wide "
    "engineered wood flooring planks lying flat on a smooth warm beige-grey "
    "concrete surface. The planks enter the frame from the corners and the edges "
    "at varied irregular angles, pointing loosely inward, some overlapping in "
    "small stacks of two or three so their thick sawn edges catch the light and "
    "cast soft shadows. There are clear gaps of bare concrete between the groups "
    "of planks, so they do NOT form a continuous ring or border. Each plank is "
    "long and wide, at least half the width of the frame, never small chips or "
    "short blocks. Every plank is the same warm honey oak with natural grain. The "
    "centre of the image is generous empty warm beige-grey concrete occupying "
    "more than half the frame, seamless, with no tile joints. Asymmetric, loose "
    "and editorial: NOT symmetrical, NOT a sunburst, NOT a mandala, NOT a "
    "circular frame. Warm directional daylight from the upper right, soft "
    "realistic shadows. Sophisticated architectural material photography, "
    "photorealistic, sharp. No people, no furniture, no room, no text, "
    "no logos, no watermark."
)

EDIT_PREFIX = (
    "Keep the composition pixel-identical: exactly the same plank arrangement, "
    "the same angles, the same overlaps, the same shadows, the same greige "
    "concrete in the centre, the same lighting and framing. Do not move anything. "
    "Change ONLY the wood species and colour of every plank to: "
)

BASE_NAME = "flat_natural_uv_grande"
VARIANTS = [
    (
        "flat_natural_uv_chico",
        EDIT_PREFIX
...
def main():
    ...
    print("1/4 — bodegón base (Roble Natural UV 14/3)")
