...
SR=48000; DUR=21.0; N=int(SR*DUR); OFF=4.42
...
g[s2i(20.97):]*=np.linspace(1,0,N-s2i(20.97))                    # corte seco
mix*=g[:,None]; peak=np.abs(mix).max(); mix*=(10**(-1/20))/max(peak,1e-9)
wav=os.path.join(AU,'banda-v7.wav'); mp3=os.path.join(AU,'banda-v7.mp3')
