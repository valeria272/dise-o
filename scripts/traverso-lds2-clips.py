...
P={
 ...
 'c17':(f'{K}/k08b_entrada_alta.png',None,"Seen from behind, the three characters take two slow steps towards the tall glass entrance; the doors open inward and the warm light from inside grows brighter and brighter until it floods the frame. The camera stays LOCKED at hip height, no zoom. The architecture does not move; nothing crosses the characters. "+LOCK,'fisica','kling-v2-5-pro'),
 'c16':(f'{K}/e10b_reunion_equipo.png',None,"The three characters sit dead serious at the table: the gold one in the centre reads the printed contract and turns it slightly, the red one taps once on the laptop, the yellow one stays still. In the foreground the two people seen from behind talk to them, the man gesturing gently with his hand, the woman nodding once. Warm natural light, locked camera. No faces of the people shown. "+LOCK,None,'kling-v2-5-pro'),
