...
import {MatchPerfectoNuevo} from './compositions/hilton/BetweenPrueba';
import {CumpleFestivoPortada, CumpleFestivoDetalles} from './compositions/hilton/BetweenCumple';
...
const Raiz: React.FC = () => (
  <>
    <Folder name="BW-Prueba">
      <Composition id="BW-P-MatchPerfecto" component={MatchPerfectoNuevo} {...feed} />
    </Folder>
    <Folder name="BW-Feed">
      ...
      <Composition id="BW-F-Cumple-1" component={CumpleFestivoPortada} {...feed} />
      <Composition id="BW-F-Cumple-2" component={CumpleFestivoDetalles} {...feed} />
    ...
    <Folder name="BW-Stories">
      ...
      <Composition id="BW-S-Animada" component={StAnimadaToGo} durationInFrames={225} fps={30} width={1080} height={1920} />
    </Folder>
  </>
);
