// ============================================================================
// G.CL / CAP.02 — «TURNO DE NOCHE» · CORTE 11 · DEFINITIVO (= corte 10 + 1 s en el post-it + termina en la explosión)
...
export const Cap02TurnoDeNocheV11: React.FC = () => {
  asegurarFuentes();
  return (
