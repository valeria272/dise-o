// ============================================================================
// G.CL / CAP.02 — «TURNO DE NOCHE» · CORTE 12 · DEFINITIVO (= corte 11 + la tarjeta de cierre de serie)
...
// «Departamento de cosas imposibles» + PRÓXIMO CAPÍTULO, con el golpe final del tema.
...
const PLANOS: Plano[] = [
  ...
  {id: "N13", dur: 40, desde: 1.9, vel: 1.8},
...
export const TURNO_V12_FRAMES = PLANOS.reduce((a, p) => a + p.dur, 0);
...
export const Cap02TurnoDeNocheV12: React.FC = () => {
  asegurarFuentes();
  return (
