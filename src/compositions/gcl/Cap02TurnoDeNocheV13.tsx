// ============================================================================
// G.CL / CAP.02 — «TURNO DE NOCHE» · CORTE 13 · DEFINITIVO (= corte 12 sin el reenvío hacia abajo)
...
export const TURNO_V13_FRAMES = PLANOS.reduce((a, p) => a + p.dur, 0);
...
//   El cierre va SIN MÚSICA (corte 13): sólo el tecleo de la tarjeta.
...
export const Cap02TurnoDeNocheV13: React.FC = () => {
  asegurarFuentes();
  return (
