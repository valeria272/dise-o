// ============================================================================
// G.CL / CAP.02 — «TURNO DE NOCHE» · CORTE 15 · DEFINITIVO = corte 14 con la música BAJANDO al terminar el trabajo
...
export const TURNO_V15_FRAMES = PLANOS.reduce((a, p) => a + p.dur, 0);
...
export const Cap02TurnoDeNocheV15: React.FC = () => {
  asegurarFuentes();
  return (
