/**
 * TRAVERSO × GRUPO COPYLAB — «LOS DE SIEMPRE · THE ENTRANCE» V4 — RUTA B HÍBRIDA (22,5 s · 24 fps)
 * ----------------------------------------------------------------------------
...
export const ENT4_FPS = 24;
export const ENT4_W = 1080;
export const ENT4_H = 1920;
export const ENT4_DURATION = Math.round(22.5 * ENT4_FPS); // 540

const A = "assets/traverso/lds2";
const F = (s: number) => Math.round(s * ENT4_FPS);
const INK = "#050505";
const BONE = "#F2EEE7";
...
// Eventos MEDIDOS de audio/banda-v4.mp3 (scripts/traverso-lds2-banda-v4.py): italiano 0–1,30 ·
// QUIEBRE 1,30 · golpes 2,00 / 4,52 / 5,00 / 5,72 / 6,16 · vacío 8,66–9,18 · DROP 9,18 ·
// tres beats 11,94 / 12,38 / 12,86 · parada 14,16–14,66 · hit de la luz 15,16 · bache 17,16 ·
// banda atrás 17,66–20,0 · vuelve 20,0 · HIT 21,66 · corte 22,5
const DROP = 9.18;
const T = {c1: 0.0, c2: 0.45, c3: 0.9, boom: 1.3, trio: 2.0, r1: 4.52, r2: 5.0, r3: 5.72, prep: 6.16, vacio: 8.66, reveal: DROP,
  porn: 11.94, puerta: 13.3, entran: 15.16, mesa: 16.4, end: 20.0, fin: 22.5};
...
const PLANOS: Plano[] = [
  ...
  {id: "c10", from: T.porn, to: 12.38, src: "c10.mp4", trim: 1.0, rate: 1.5, punch: 1.05},
  {id: "c11", from: 12.38, to: 12.86, src: "c11.mp4", trim: 1.0, rate: 1.5, punch: 1.05},
  {id: "c12", from: 12.86, to: T.puerta, src: "c12.mp4", trim: 1.0, rate: 1.5, punch: 1.05},
  {id: "c13", from: T.puerta, to: T.entran, src: "c13.mp4", trim: 0.3, rate: 2.4, burn: true},
  {id: "c14", from: T.entran, to: T.mesa, src: "c14.mp4", trim: 2.4, rate: 2.0, fromWhite: true},
  {id: "c15", from: T.mesa, to: T.end, src: "c15.mp4", trim: 0.3, rate: 1.2},
];
...
const SFX: {src: string; at: number; vol: number; dur?: number; base?: string}[] = [
  ...
  {src: "sfx-bass.mp3", at: T.boom, vol: 0.9}, {src: "sfx-camara.mp3", at: T.boom, vol: 0.5}, {src: "sfx-impacto.mp3", at: T.boom, vol: 0.5},
  ...
  {src: "sfx-impacto.mp3", at: T.porn, vol: 0.5}, {src: "sfx-impacto.mp3", at: 12.38, vol: 0.5}, {src: "sfx-impacto.mp3", at: 12.86, vol: 0.5},
  {src: "sfx-brillo.mp3", at: T.porn, vol: 0.35}, {src: "sfx-brillo.mp3", at: 12.38, vol: 0.35}, {src: "sfx-brillo.mp3", at: 12.86, vol: 0.35},
  {src: "sfx-pasos.mp3", at: T.puerta, vol: 0.4, dur: 1.6, base: "lds"}, {src: "sfx-riser.mp3", at: T.entran - 1.0, vol: 0.85}, {src: "sfx-puerta.mp3", at: T.entran - 0.9, vol: 0.55, base: "lds"},
  ...
  {src: "sfx-bass.mp3", at: T.end, vol: 0.6}, {src: "sfx-bass.mp3", at: 21.66, vol: 0.9},
];

export const LosDeSiempreEntranceV4: React.FC = () => {
  void fontPromise;
  return (
    <AbsoluteFill style={{background: INK}}>
      ...
      <Sequence from={F(T.end)} durationInFrames={F(T.fin - T.end)} layout="none">
        <AbsoluteFill style={{background: INK}} />
        <Sequence from={0} durationInFrames={F(1.3)} layout="none">
        ...
        <Sequence from={F(1.3)} layout="none">
      ...
      <Audio src={staticFile(`${A}/audio/banda-v4.mp3`)} volume={0.95} />
      {SFX.map((s, i) => (
